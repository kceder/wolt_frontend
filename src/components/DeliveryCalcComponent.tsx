    ...
    return (
        <>
            ...
            <div className='flex flex-col justify-center items-center'>
                <DisplayFee deliveryFee={state.deliveryFee} setSubmitted={setSubmitted} />
            </div>
        )}
            {!submitted && (
            <form className='max-w-md mx-auto bg-white rounded px-8 pt-6 pb-8 mb-4' onSubmit={handleSubmit}>
            <br />
            <p className='ml-[2.55rem] text-xs text-slate-400'>Cart value (€)</p>
            <div className='group flex flex-row items-center text-left'>
                <div className='mr-1'>
                    <svg className="transition ease-in-out group-hover:scale-125 h-6 w-6 text-blue-500"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"> 
                ...
                <div className='basis-[90%]'>
                    <input className='font-semibold text-sm w-full py-2 px-3 focus:outline-none ' placeholder='Cart Value' type="number" step="0.01" name="cartValue" onChange={handleInputChange} min="0" />
                <hr />
                </div>
            </div>
                <br />
                <p className='ml-[2.55rem] text-xs text-slate-400'>Delivery Distance (m)</p>
            <div className='group flex flex-row items-center text-left'>
                <div className='mr-1'>
                    <svg className="transition ease-in-out group-hover:scale-125 h-6 w-6 text-blue-500"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"> 
                ...
                <div className='basis-[90%]'>
                    <input className='font-semibold text-sm w-full py-2 px-3 focus:outline-none' placeholder='Delivery Distance' type="number" name="deliveryDistance" onChange={handleInputChange} min="0" />
                <hr />
                </div>
            </div>          
                <br />
                <p className='ml-[2.55rem] text-xs text-slate-400'>Number of Items</p>
            <div className='group flex flex-row items-center text-left'>
                <div className='mr-1'>
                <svg className="transition ease-in-out group-hover:scale-125 h-6 w-6 text-blue-500"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">
                ...
                <div className='basis-[90%]'>
                    <input className='font-semibold text-sm w-full py-2 px-3 focus:outline-none' placeholder='Number of Items' type="number" name="numberOfItems" onChange={handleInputChange} min="0" />
                <hr />
                </div>
            </div>
                <br />
                <p className='ml-[2.55rem] text-xs text-slate-400'>Order Time</p>
            <div className='group flex flex-row items-center text-left'>
                <div className='mr-1'>
                    <svg className="transition ease-in-out group-hover:scale-125 h-6 w-6 text-blue-500"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z"/>
            ...
            <br />
            <br />
            <button className='block border font-semibold hover:bg-[#44b1f4] rounded-lg text-sm mx-auto px-4 py-2 focus:outline-none' type="submit" onClick={() => handleCalculate(state, setState)}>Calculate</button>
        </form>
        )}
        </>
    )
